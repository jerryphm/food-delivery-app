      ...
      <section>
         ...
         <div className=''>
            <div>
               ...
               <div className='mt-20'>
                  <div className='sm:w-[80%] border-b-[1px] border-lpink'>
                     <button
                        onClick={() => setReviews(true)}
                        className={`px-3 py-[1px] md:px-4 md:py-[2px] rounded-sm mr-3 font-rnroll ${isReviews ?'bg-lpink' :null}`}
                     >
                        Reviews
                     </button>
                     <button
                        onClick={() => setReviews(false)}
                        className={`px-3 py-[1px] md:px-4 md:py-[2px] rounded-sm font-rnroll ${isReviews ?null :'bg-lpink'}`}
                     >
                        Description
                     </button>
                  </div>
